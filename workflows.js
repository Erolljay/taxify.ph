  ...
  vat: {
    ...
    steps: [
      ...
      },
      {
        ...
        help: 'Download everything you prepared in this workflow, then the full working paper as one PDF.',
        bundle: ['sls-download', 'slp-download', 'sawt-download'],
        pdfBundle: ['vat-2550q-review', 'sls-review', 'slp-review', 'sawt-download'],
      },
    ],
  },
